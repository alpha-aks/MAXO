...
// Orb Component - WebGL animated orb background
...
export default function TiltedCard({
  ...
  scaleOnHover = 1.1,
  rotateAmplitude = 14,
  showMobileWarning: _showMobileWarning = false, // Kept for API compatibility
  showTooltip = true,
  overlayContent = null,
  ...
  function handleMouse(e: React.MouseEvent<HTMLElement> | React.TouchEvent<HTMLElement>) {
